Ext.define('MyApp.controller.ConfirmController', {
    ...
    onConfirm: function (record) {
        ...
        var fromStore = MyApp.getApplication().getStore('ItemDataStore');
        var createConfirmationReportStore = fromStore.filterAndCollectToNewStore(fromStore,
        ...
        var confirmWindow = Ext.create('MyApp.view.ConfirmWindow', {
            id: "ConfirmWindow",
            store: createConfirmationReportStore,
            onSave: function () {
